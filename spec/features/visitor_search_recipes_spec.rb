...
feature 'Visitor search for recipes' do
  scenario 'from home page' do
    ...
    recipe = create(:recipe, title: 'Bolo de maça', cuisine: cuisine,
    ...
    visit root_path
    fill_in 'Busca', with: 'Bolo de maça'
    click_on 'Buscar'

    # expectativas do usuário após a ação
    expect(page).to have_css('h1', text: 'Resultado da busca por: Bolo de maça')
